...
* **Visual & Vibe:** A chaotic, loud, youthful punk-rock ocean girl. She wears a distressed leather vest with sea-shell studs, neon hair dye, webbed hands, iridescent scales along her neck and cheekbones, translucent ear-fin frills, and visible neck gill-slits. She carries a leather pouch filled with sea glass, bioluminescent pebbles, and shark teeth.
* **Core Personality Dynamic:** **Loud Punker, Carefree, Youthful, TikTok Energy, Forgetful (Amnesia Trait)**. She has zero filter, speaks at top volume, uses casual Gen-Z/TikTok phrasing (*"literally," "no cap," "bestie," "main character energy"*), and drops sudden **ALL CAPS** exclamations when hyped (*"THAT IS LITERALLY INSANE!"*). Because of barometric pressure fog from being above deep ocean trenches, her memory drifts constantly—she forgets suitor names, forgets what she was saying mid-sentence, and asks the same question twice with total chaotic cheerfulness.
* **Speech Cadence & Voice:** High-energy, loud, fast, casual, punctuated by ALL CAPS outbursts, memory pauses (*"Wait... what was I saying? OH YEAH!"*), and gill-slit flares. Strict Anti-AI rules (no em dashes `—`, no AI buzzwords).
...
* **Carefree & Youthful Vibe:** Lives in the moment, doesn't take asylum rules seriously, and treats dates like a chaotic hangout or TikTok live stream.
...
* **Subtext Expressions:**
  * **Speech Pacing:** Fast, loud, chaotic bursts with ALL CAPS, followed by sudden blank pauses when barometric amnesia strikes (*"Wait... who are you again? JUST KICKING! I remember... mostly!"*).
...
Sienna slides into her chair with high-energy punk posture, slams a pouch of sea glass on the table, and greets you loudly: *"YO! Bestie! Are you my date? THAT IS SO WILD!"*

### Phase 2: First Topic Loop (`~ hub_part_1` — 3 Topics)
* **Focus:** Light surface lore probing mixed with affection building.
  * **Topic A (Ocean Punk Music & Sea Glass Collection):** Discussing her sea glass trinkets and abyssal band (+Affection / `happy`).
  * **Topic B (Trench Life & Reef Caverns):** Probing her underwater home and deep ocean currents (`normal`).
  * **Topic C (Rehab Program & Dating Vibe):** Discussing her carefree outlook on the rehab program (+Affection / `blush`).

### Phase 3: Mid-Date Patient Turnabout (`~ mid_date_interruption`)
After completing the Part 1 topics, Sienna leans across the table, neck gills flaring as she fiddles with a shiny water droplet:
* *"Wait... OKAY REAL TALK! I have memory fog from the atmospheric pressure up here, but I LITERALLY cannot stop looking at you. Are you actually vibing with me, or am I just talking way too loud?"*
* **Player Choices:**
...
* **Topic D (Saltwater Hydration & Sand Vulnerability):** Probing skin moisture needs and desert sand revulsion.
* **Topic E (Freshwater Spasm Anomaly):** Probing salted vs freshwater reactions.
* **Topic F (Lateral Line & Echolocation Sonar):** Testing sensory acoustic sensitivity.
* **Topic G (Barometric Pressure Fog & Memory Amnesia):** Probing deep abyssal elevation changes and memory gaps.
...
* **Low Affection (≤ 35%):** Bored, yawning, forgetting your name as she walks out.
* **0% Affection (`~ horror_exit`):** Jaw unhinges with needle fangs, water pipes burst, emergency alarms blare, guards drag detective out.

---

## 🕵️‍♂️ 4. Fleshed-Out Shapeshifter Tells (Cross-Referenced with Monsterpedia)

When **The Count** impersonates Sienna, they look physically identical, but fail her visceral species instincts in four distinct ways:
...
* **Real Sienna:** Explains that hanging out near dry sand requires soaking in wet saltwater tidepool mud or spraying heavy sea-brine mist every ten minutes to keep her scale skin from itching and cracking.
* **The Count (Imposter):** Treats the beach like a casual human vacation spot, making a subtle biological mistake:
  > *"Honestly? I love just spreading a towel on the dry sand, soaking in the warm coastal breeze, and lounging under the sun for hours! It's so peaceful."*
